...
class ContractListView(ttk.Frame):
    ...
    def create_widgets(self):
        self.img_title_tk = EmojiCache(size=32).get("1f4dd.png") # Chart decreasing
        self.title_label = ttk.Label(self, text="Contracts", font=("", 30), image=self.img_title_tk, compound="left")
